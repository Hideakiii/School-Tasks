...
game = Game()
game.players = [Player(game=game), Player()]
...
def Game_Loop():
    ...
    p2 = Player(pygame.image.load('Pixelart_P2.jpeg'),False,False,None,3,0,display_width * 0.5,display_height * 0.8 ,0,0)
    ...
    P1_lives = p1.Lives("Player 1 Lives: ", 3,(0,20))
    P2_lives = p2.Lives("Player 2 Lives: ", 3,(0,40))

    object1 = Objekts(random.randrange(0,display_width),-700,75,75, 5)
    object2 = Objekts(random.randrange(0,display_width),-700,45,45, 4)
    ...
    objects = [Objekts(random.randrange(0,display_width),-700,75,75, 5),
               Objekts(random.randrange(0,display_width),-700,45,45, 4),
               Objekts(-1300,(random.randrange(0,display_height)),75,75, 5),
               Objekts(1300,(random.randrange(0,display_height)),100,100, 3)]
